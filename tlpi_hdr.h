...
plus EXIT_SUCCESS and EXIT_FAILURE constants */ /* Prototypes for many system calls */
/* Declares errno and defines error constants */ /* Commonly used string-handling functions */
